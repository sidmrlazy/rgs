<nav class="navbar navbar-expand-lg bg-light">
    <div class="container-fluid">
        <a class="navbar-brand" href="index.php">
            <img src="assets/logo/rgs-a-logo.png" alt="">
        </a>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="index.php">
                            <ion-icon name="logo-facebook" class="navbar-social-media-icons"></ion-icon>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="index.php">
                            <ion-icon name="logo-instagram" class="navbar-social-media-icons"></ion-icon>
                        </a>
                    </li>
                </ul>
            </div>
