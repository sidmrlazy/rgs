<div class="container mt-5 mb-5" id="department-desktop-view">
    <div id="carouselExample" class="carousel carousel-dark slide">
        ...
        <button class="carousel-control-prev carousel-prev-department-btn" type="button"
            data-bs-target="#carouselExample" data-bs-slide="prev">
            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
            <span class="visually-hidden">Previous</span>
        </button>
        <button class="carousel-control-next carousel-next-department-btn" type="button"
...
<div class="container mt-5 mb-5" id="department-mobile-view">
    <div id="departmentCarousel" class="carousel carousel-dark slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
        ...
        <button class="carousel-control-prev carousel-prev-department-btn" type="button"
            data-bs-target="#departmentCarousel" data-bs-slide="prev">
            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
            <span class="visually-hidden">Previous</span>
        </button>
        <button class="carousel-control-next carousel-next-department-btn" type="button"
            data-bs-target="#departmentCarousel" data-bs-slide="next">
            <span class="carousel-control-next-icon" aria-hidden="true"></span>
            <span class="visually-hidden">Next</span>
        </button>
    </div>
